...
class DatabaseClient extends $grpc.Client {
  static final _$destroyDB =
      $grpc.ClientMethod<$0.DestroyArguments, $0.StandardResponse>(
  ...
  static final _$listNodes =
      $grpc.ClientMethod<$0.SubtreeInfo, $0.ListResponse>(
  ...
  $grpc.ResponseFuture<$0.StandardResponse> destroyDB(
      $0.DestroyArguments request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$destroyDB, request, options: options);
  }

  $grpc.ResponseFuture<$0.StandardResponse> write($0.KeyValue request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$write, request, options: options);
  }

  $grpc.ResponseFuture<$0.ReadResponse> read($0.Key request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$read, request, options: options);
  }

  $grpc.ResponseFuture<$0.StandardResponse> delete($0.Key request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$delete, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListResponse> search($0.Key request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$search, request, options: options);
  }

  $grpc.ResponseFuture<$0.StandardResponse> deleteNodes($0.Key request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteNodes, request, options: options);
  }

  $grpc.ResponseFuture<$0.ListResponse> listNodes($0.SubtreeInfo request,
      {$grpc.CallOptions? options}) {
...
abstract class DatabaseServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.StandardResponse> destroyDB_Pre($grpc.ServiceCall call,
      $async.Future<$0.DestroyArguments> request) async {
    return destroyDB(call, await request);
  }

  $async.Future<$0.StandardResponse> write_Pre(
  ...
  $async.Future<$0.StandardResponse> delete_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Key> request) async {
    return delete(call, await request);
  }

  $async.Future<$0.ListResponse> search_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Key> request) async {
    return search(call, await request);
  }

  $async.Future<$0.StandardResponse> deleteNodes_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Key> request) async {
    return deleteNodes(call, await request);
  }

  $async.Future<$0.ListResponse> listNodes_Pre(
      $grpc.ServiceCall call, $async.Future<$0.SubtreeInfo> request) async {
    return listNodes(call, await request);
  }

  $async.Future<$0.StandardResponse> destroyDB(
      $grpc.ServiceCall call, $0.DestroyArguments request);
  $async.Future<$0.StandardResponse> write(
      $grpc.ServiceCall call, $0.KeyValue request);
  $async.Future<$0.ReadResponse> read($grpc.ServiceCall call, $0.Key request);
  $async.Future<$0.StandardResponse> delete(
      $grpc.ServiceCall call, $0.Key request);
  $async.Future<$0.ListResponse> search($grpc.ServiceCall call, $0.Key request);
  $async.Future<$0.StandardResponse> deleteNodes(
      $grpc.ServiceCall call, $0.Key request);
  $async.Future<$0.ListResponse> listNodes(
      $grpc.ServiceCall call, $0.SubtreeInfo request);
}
