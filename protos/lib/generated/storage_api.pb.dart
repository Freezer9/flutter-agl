...
class Key extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'storage_api'),
...
class SubtreeInfo extends $pb.GeneratedMessage {
  ...
  SubtreeInfo._() : super();
  factory SubtreeInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SubtreeInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SubtreeInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'storage_api'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SubtreeInfo copyWith(void Function(SubtreeInfo) updates) =>
      super.copyWith((message) => updates(message as SubtreeInfo))
          as SubtreeInfo;
  ...
  @$core.pragma('dart2js:noInline')
  static SubtreeInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SubtreeInfo>(create);
...
class DestroyArguments extends $pb.GeneratedMessage {
  ...
  factory DestroyArguments.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DestroyArguments.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DestroyArguments',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'storage_api'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DestroyArguments copyWith(void Function(DestroyArguments) updates) =>
      super.copyWith((message) => updates(message as DestroyArguments))
          as DestroyArguments;
  ...
  static $pb.PbList<DestroyArguments> createRepeated() =>
      $pb.PbList<DestroyArguments>();
  @$core.pragma('dart2js:noInline')
  static DestroyArguments getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DestroyArguments>(create);
...
class StandardResponse extends $pb.GeneratedMessage {
  ...
  factory StandardResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StandardResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'StandardResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'storage_api'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  StandardResponse copyWith(void Function(StandardResponse) updates) =>
      super.copyWith((message) => updates(message as StandardResponse))
          as StandardResponse;
  ...
  static $pb.PbList<StandardResponse> createRepeated() =>
      $pb.PbList<StandardResponse>();
  @$core.pragma('dart2js:noInline')
  static StandardResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<StandardResponse>(create);
