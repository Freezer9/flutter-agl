...
class STTFramework extends $pb.ProtobufEnum {
  static const STTFramework VOSK =
      STTFramework._(0, _omitEnumNames ? '' : 'VOSK');
  static const STTFramework WHISPER =
      STTFramework._(1, _omitEnumNames ? '' : 'WHISPER');
  ...
  static final $core.Map<$core.int, STTFramework> _byValue =
...
class OnlineMode extends $pb.ProtobufEnum {
  static const OnlineMode ONLINE =
      OnlineMode._(0, _omitEnumNames ? '' : 'ONLINE');
  static const OnlineMode OFFLINE =
      OnlineMode._(1, _omitEnumNames ? '' : 'OFFLINE');
  ...
  static final $core.Map<$core.int, OnlineMode> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class RecognizeStatusType extends $pb.ProtobufEnum {
  ...
  static const RecognizeStatusType TEXT_NOT_RECOGNIZED =
      RecognizeStatusType._(5, _omitEnumNames ? '' : 'TEXT_NOT_RECOGNIZED');
  static const RecognizeStatusType NLU_MODEL_NOT_SUPPORTED =
      RecognizeStatusType._(6, _omitEnumNames ? '' : 'NLU_MODEL_NOT_SUPPORTED');
