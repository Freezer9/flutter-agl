...
class VoiceAudio extends $pb.GeneratedMessage {
  ...
  VoiceAudio._() : super();
  factory VoiceAudio.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory VoiceAudio.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  @$pb.TagNumber(1)
  set audioChunk($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
...
class S_RecognizeVoiceControl extends $pb.GeneratedMessage {
  ...
  factory S_RecognizeVoiceControl.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory S_RecognizeVoiceControl.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'S_RecognizeVoiceControl',
      createEmptyInstance: create)
    ..aOM<VoiceAudio>(1, _omitFieldNames ? '' : 'audioStream',
    ...
    ..e<STTFramework>(
        4, _omitFieldNames ? '' : 'sttFramework', $pb.PbFieldType.OE,
        defaultOrMaker: STTFramework.VOSK,
        valueOf: STTFramework.valueOf,
        enumValues: STTFramework.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  S_RecognizeVoiceControl clone() =>
      S_RecognizeVoiceControl()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  S_RecognizeVoiceControl copyWith(
          void Function(S_RecognizeVoiceControl) updates) =>
      super.copyWith((message) => updates(message as S_RecognizeVoiceControl))
          as S_RecognizeVoiceControl;
  ...
  static $pb.PbList<S_RecognizeVoiceControl> createRepeated() =>
      $pb.PbList<S_RecognizeVoiceControl>();
  @$core.pragma('dart2js:noInline')
  static S_RecognizeVoiceControl getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<S_RecognizeVoiceControl>(create);
  static S_RecognizeVoiceControl? _defaultInstance;

  @$pb.TagNumber(1)
  VoiceAudio get audioStream => $_getN(0);
  @$pb.TagNumber(1)
  set audioStream(VoiceAudio v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(4)
  set sttFramework(STTFramework v) {
    setField(4, v);
  }
...
class RecognizeVoiceControl extends $pb.GeneratedMessage {
  ...
  factory RecognizeVoiceControl.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RecognizeVoiceControl.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RecognizeVoiceControl',
      createEmptyInstance: create)
    ...
    ..e<STTFramework>(
        5, _omitFieldNames ? '' : 'sttFramework', $pb.PbFieldType.OE,
        defaultOrMaker: STTFramework.VOSK,
        valueOf: STTFramework.valueOf,
        enumValues: STTFramework.values)
    ..e<OnlineMode>(6, _omitFieldNames ? '' : 'onlineMode', $pb.PbFieldType.OE,
        defaultOrMaker: OnlineMode.ONLINE,
        valueOf: OnlineMode.valueOf,
        enumValues: OnlineMode.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  RecognizeVoiceControl clone() =>
      RecognizeVoiceControl()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RecognizeVoiceControl copyWith(
          void Function(RecognizeVoiceControl) updates) =>
      super.copyWith((message) => updates(message as RecognizeVoiceControl))
  ...
  static $pb.PbList<RecognizeVoiceControl> createRepeated() =>
      $pb.PbList<RecognizeVoiceControl>();
  @$core.pragma('dart2js:noInline')
  static RecognizeVoiceControl getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RecognizeVoiceControl>(create);
...
class RecognizeTextControl extends $pb.GeneratedMessage {
  ...
  factory RecognizeTextControl.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RecognizeTextControl.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RecognizeTextControl',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  RecognizeTextControl clone() =>
      RecognizeTextControl()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RecognizeTextControl copyWith(void Function(RecognizeTextControl) updates) =>
      super.copyWith((message) => updates(message as RecognizeTextControl))
          as RecognizeTextControl;
  ...
  static $pb.PbList<RecognizeTextControl> createRepeated() =>
      $pb.PbList<RecognizeTextControl>();
  @$core.pragma('dart2js:noInline')
  static RecognizeTextControl getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RecognizeTextControl>(create);
  static RecognizeTextControl? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get textCommand => $_getSZ(0);
  @$pb.TagNumber(1)
  set textCommand($core.String v) {
    $_setString(0, v);
  }
...
class VoiceAgentServiceApi {
  ...
  $async.Future<ServiceStatus> checkServiceStatus(
          $pb.ClientContext? ctx, Empty request) =>
      _client.invoke<ServiceStatus>(ctx, 'VoiceAgentService',
          'CheckServiceStatus', request, ServiceStatus());
  $async.Future<WakeWordStatus> s_DetectWakeWord(
          $pb.ClientContext? ctx, VoiceAudio request) =>
      _client.invoke<WakeWordStatus>(ctx, 'VoiceAgentService',
          'S_DetectWakeWord', request, WakeWordStatus());
  $async.Future<WakeWordStatus> detectWakeWord(
          $pb.ClientContext? ctx, Empty request) =>
      _client.invoke<WakeWordStatus>(ctx, 'VoiceAgentService', 'DetectWakeWord',
          request, WakeWordStatus());
  $async.Future<RecognizeResult> s_RecognizeVoiceCommand(
          $pb.ClientContext? ctx, S_RecognizeVoiceControl request) =>
      _client.invoke<RecognizeResult>(ctx, 'VoiceAgentService',
          'S_RecognizeVoiceCommand', request, RecognizeResult());
  $async.Future<RecognizeResult> recognizeVoiceCommand(
          $pb.ClientContext? ctx, RecognizeVoiceControl request) =>
      _client.invoke<RecognizeResult>(ctx, 'VoiceAgentService',
          'RecognizeVoiceCommand', request, RecognizeResult());
  $async.Future<RecognizeResult> recognizeTextCommand(
          $pb.ClientContext? ctx, RecognizeTextControl request) =>
      _client.invoke<RecognizeResult>(ctx, 'VoiceAgentService',
          'RecognizeTextCommand', request, RecognizeResult());
  $async.Future<ExecuteResult> executeCommand(
          $pb.ClientContext? ctx, ExecuteInput request) =>
      _client.invoke<ExecuteResult>(
          ctx, 'VoiceAgentService', 'ExecuteCommand', request, ExecuteResult());
}
